...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'account_userprofile', (
            ...
            ('skype_id', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ...
        db.create_table(u'account_messages', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ...
            ('msgbody', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('submitted_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'account', ['Messages'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'account_messages')
    ...
    models = {
        ...
        u'account.userprofile': {
            ...
            'skype_id': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
