...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'account_specialist', (
            ...
            ('status', self.gf('django.db.models.fields.CharField')(default='OF', max_length=2)),
            ('rate', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=11, decimal_places=2)),
            ('details', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'account', ['Specialist'])


    def backwards(self, orm):
        # Deleting model 'Specialist'
        db.delete_table(u'account_specialist')
    ...
    models = {
        u'account.messages': {
            ...
            'msgbody': ('django.db.models.fields.CharField', [], {'max_length': '500'}),
            ...
            'submitted_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        u'account.specialist': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'OF'", 'max_length': '2'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True'})
        },
        u'account.userprofile': {
            'Meta': {'object_name': 'UserProfile'},
            'access_type': ('django.db.models.fields.CharField', [], {'default': "'NO'", 'max_length': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
