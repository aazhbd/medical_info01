...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PatientVisit'
        db.create_table(u'admission_patientvisit', (
        ...
        db.send_create_signal(u'admission', ['PatientVisit'])
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'admission_patientadmission', (
            ...
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('visit', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('hospital_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('date_of_admission', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        ...
        # Deleting model 'PatientVisit'
        db.delete_table(u'admission_patientvisit')
