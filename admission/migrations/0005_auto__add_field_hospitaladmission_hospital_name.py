...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HospitalAdmission.hospital_name'
        db.add_column(u'admission_hospitaladmission', 'hospital_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HospitalAdmission.hospital_name'
        db.delete_column(u'admission_hospitaladmission', 'hospital_name')
