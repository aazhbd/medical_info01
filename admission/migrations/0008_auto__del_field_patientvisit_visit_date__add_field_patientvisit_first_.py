...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PatientVisit.visit_date'
        db.delete_column(u'admission_patientvisit', 'visit_date')
    ...
    def backwards(self, orm):
        # Adding field 'PatientVisit.visit_date'
        db.add_column(u'admission_patientvisit', 'visit_date',
