...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Teleconsultation.details'
        db.add_column(u'consultation_teleconsultation', 'details',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Teleconsultation.details'
        db.delete_column(u'consultation_teleconsultation', 'details')
