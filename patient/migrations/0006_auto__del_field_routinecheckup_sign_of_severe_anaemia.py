...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Routinecheckup.sign_of_severe_anaemia'
        db.delete_column(u'patient_routinecheckup', 'sign_of_severe_anaemia_id')


    def backwards(self, orm):
        # Adding field 'Routinecheckup.sign_of_severe_anaemia'
        db.add_column(u'patient_routinecheckup', 'sign_of_severe_anaemia',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['patient.Signanaemia']),
                      keep_default=False)
