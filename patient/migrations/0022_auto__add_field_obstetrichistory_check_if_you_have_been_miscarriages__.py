...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObstetricHistory.check_if_you_have_been_miscarriages'
        db.add_column(u'patient_obstetrichistory', 'check_if_you_have_been_miscarriages',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2),
                      keep_default=False)

        # Adding field 'ObstetricHistory.check_if_you_have_been_pregnant'
        db.add_column(u'patient_obstetrichistory', 'check_if_you_have_been_pregnant',
                      self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObstetricHistory.check_if_you_have_been_miscarriages'
        db.delete_column(u'patient_obstetrichistory', 'check_if_you_have_been_miscarriages')

        # Deleting field 'ObstetricHistory.check_if_you_have_been_pregnant'
        db.delete_column(u'patient_obstetrichistory', 'check_if_you_have_been_pregnant')
