...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'patient_previousobstetrichistory', 'year')

        # Adding field 'PreviousObstetricHistory.dob'
        db.add_column(u'patient_previousobstetrichistory', 'dob',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 19, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PreviousObstetricHistory.year'
        db.add_column(u'patient_previousobstetrichistory', 'year',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 19, 0, 0)),
                      keep_default=False)

        # Deleting field 'PreviousObstetricHistory.dob'
        db.delete_column(u'patient_previousobstetrichistory', 'dob')
