...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UltrasoundScanningImage'
        db.create_table(u'patient_ultrasoundscanningimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('us', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['patient.UltrasoundScanning'], null=True, blank=True)),
            ('image', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'patient', ['UltrasoundScanningImage'])
    ...
    def backwards(self, orm):
        # Deleting model 'UltrasoundScanningImage'
        db.delete_table(u'patient_ultrasoundscanningimage')
