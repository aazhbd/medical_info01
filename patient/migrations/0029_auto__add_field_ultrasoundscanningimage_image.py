...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UltrasoundScanningImage.image'
        db.add_column(u'patient_ultrasoundscanningimage', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UltrasoundScanningImage.image'
        db.delete_column(u'patient_ultrasoundscanningimage', 'image')
