...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PatientInformation.telephone_number'
        db.alter_column('patient_patientinformation', 'telephone_number', self.gf('django.db.models.fields.IntegerField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'PatientInformation.telephone_number'
        db.alter_column('patient_patientinformation', 'telephone_number', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        ...
        'patient.patientinformation': {
            ...
            'telephone_number': ('django.db.models.fields.IntegerField', [], {'max_length': '15'})
        },
